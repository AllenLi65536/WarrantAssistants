...
namespace WarrantDataManager
{
    ...
    public static class LoginSet
    {
        ...
        public static string warrantSysSqlConnString = "SERVER=10.100.10.131;DATABASE=WAFT;UID=warpap;PWD=warpap";
        public static string edaisysConnString = "SERVER=10.100.10.131;DATABASE=EDAISYS;UID=eduser;PWD=eduser";
    }

...
namespace WarrantDataManager2._0
{
    public class DataCollect
    {
        ...
        {
            SqlCommand cmd=new SqlCommand("DELETE FROM [WarrantUnderlying]",conn);
            conn.Open();
            cmd.ExecuteNonQuery();
            cmd.Dispose();
            conn.Close();
        ...
        private void insertWarrantUnderlying()
        {
            try
            {
                ...
                SqlCommand cmd1 = new SqlCommand(@"INSERT INTO [EDIS].[dbo].[WarrantUnderlying] (UnderlyingID, UnderlyingIDCMoney, UnderlyingName, TraderID, TraderName, StockType, FullName) 
                ...
                //先預設市場是TSE，以免有些比對不到
                cmd1 = new SqlCommand("UPDATE [EDIS].[dbo].[WarrantUnderlying] SET [Market]='TSE'", conn);
                cmd1.ExecuteNonQuery();
                cmd1.Dispose();

                //先從權證系統找市場
                cmd1 = new SqlCommand(@"UPDATE [EDIS].[dbo].[WarrantUnderlying] 
        ...
        {
            SqlCommand cmd = new SqlCommand("DELETE FROM [WarrantBasic]", conn);
            conn.Open();
            cmd.ExecuteNonQuery();
            cmd.Dispose();
            conn.Close();
        ...
        {
            SqlCommand cmd = new SqlCommand(@"INSERT INTO [EDIS].[dbo].[WarrantBasic]
                                              SELECT a.wid
                                                    ,a.wname
                                                    ,a.stkid
                                                    ,a.stkname
        ...
        {
            SqlCommand cmd1 = new SqlCommand("DELETE FROM [WarrantUnderlyingCredit]", conn);
            SqlCommand cmd2 = new SqlCommand("DELETE FROM [WarrantReward]", conn);
            conn.Open();
            cmd1.ExecuteNonQuery();
            cmd1.Dispose();
        ...
        {
            SqlCommand cmd1 = new SqlCommand(@"INSERT INTO EDIS.dbo.WarrantUnderlyingCredit (UnderlyingID, MDate, DataDate, Market, AvailableShares, IssuedPercent, CanIssue, CanFurthurIssue)
                                            SELECT
        ...
        {
            SqlCommand cmd = new SqlCommand("DELETE FROM [WarrantPrices]", conn);
            conn.Open();
            cmd.ExecuteNonQuery();
            cmd.Dispose();
            conn.Close();
        ...
        {
            SqlCommand cmd = new SqlCommand(@"INSERT INTO EDIS.dbo.WarrantPrices 
        ...
        {
            SqlCommand cmd = new SqlCommand("DELETE FROM [WarrantUnderlyingSummary]", conn);
            conn.Open();
            cmd.ExecuteNonQuery();
            cmd.Dispose();
            conn.Close();
        ...
        private void insertWarrantUnderlyingSummary()
        {
            ...
            //更新是否可發行
            //先預設都可以發行
            SqlCommand cmd2 = new SqlCommand("UPDATE [EDIS].[dbo].[WarrantUnderlyingSummary] SET [Issuable]='Y'", conn);
            conn.Open();
            cmd2.ExecuteNonQuery();
            cmd2.Dispose();
            conn.Close();
        ...
        {
            SqlCommand cmd1 = new SqlCommand("DELETE FROM [ApplyOfficial]", conn);
            SqlCommand cmd2 = new SqlCommand("DELETE FROM [ReIssueOfficial]", conn);
            SqlCommand cmd3 = new SqlCommand("DELETE FROM [ApplyTotalList]", conn);
            SqlCommand cmd4 = new SqlCommand("UPDATE [EDIS].[dbo].[ApplyTempList] SET ConfirmChecked='N'", conn);
            SqlCommand cmd5 = new SqlCommand("UPDATE [EDIS].[dbo].[ReIssueTempList] SET ConfirmChecked='N'", conn);

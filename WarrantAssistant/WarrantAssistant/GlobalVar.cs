    ...
    public class GlobalUtility
    {
        ...
        public static void LoadLoginSet() {
            GlobalVar.loginSet = new LoginSet {
                ...
                warrantSysSqlConnString = "SERVER=10.100.10.131;DATABASE=WAFT;UID=eduser;PWD=eduser",
                warrantSysKeySqlConnString = "SERVER=10.100.10.131;DATABASE=EDAISYS;UID=eduser;PWD=eduser"
            };
        }
